        ...
        <table class="mt-4 pro-table-pg table-hover wrapper">
            ...
            @foreach ($bills as $bill)             
                <tr>
                    ...
                    <td data-label="Amount">₹{{$bill->amount ?? "N/A"}} @if($bill->type == "CR") <span class="badge bg-success text-white mx-2"> {{$bill->type}}</span> @else <span class="badge bg-danger text-white mx-2">{{$bill->type}}</span> @endif</td>
